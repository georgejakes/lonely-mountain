...
//Get list of rooms near point

exports.query_near = function(req, res){

  var point = [req.params.lat,req.params.lon];
  var query = Room.find();
  console.log(point);
  ...
  //     maxDistance: 1000
  // });
  query.where('location').near({ center: [10, 10], maxDistance: 5 });
